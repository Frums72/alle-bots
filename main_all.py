...
# ============================================================
BOT_VERSION      = "v59.18"
BOT_VERSION_INFO = "Quoten-Linienfilter-Fix (CornerRush/Druck/Comeback/RotkarteEcken ohne Fake-Quote)"
...
def af_odds_beste_quote(fixture_id, linie: float = None, richtung: str = None) -> float:
...
def af_odds_details(fixture_id, linie: float = None, richtung: str = None) -> dict:
...
def get_quote(match_id, typ=None, linie: float = None, richtung: str = None):
    """
    ...
    wird statt (wie vorher) blind die höchste Quote über alle Linien hinweg (siehe
    af_odds_beste_quote-Kommentar für Details zum Bug).
    """
    return af_odds_beste_quote(match_id, linie=linie, richtung=richtung)
...
def get_quote_details(match_id, linie: float = None, richtung: str = None):
    """v59.1: Quoten jetzt über API-Football (fixture-basiert), nicht mehr the-odds-api.com.
    v59.18 FIX: linie/richtung ergänzt, siehe af_odds_beste_quote-Kommentar."""
    return af_odds_details(match_id, linie=linie, richtung=richtung)
