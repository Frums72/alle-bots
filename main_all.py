...
# ============================================================
BOT_VERSION      = "v60.3"
BOT_VERSION_INFO = "BUGFIX: Match-Statistiken (Ecken/Schuesse/Paraden/Ballbesitz) kamen seit der livescore-api.com Umstellung IMMER als 0 zurueck (falsches Antwortformat angenommen + falscher Parametername) - dadurch haben fast alle Live-Bots nie ausgeloest"
